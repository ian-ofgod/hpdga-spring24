...
int main() {
    const string base_dir = "/home/users/ian.didio/hpdga-spring24/hnsw/";
    ...
    // const string ground_truth_path = base_dir + "datasets/sift/sift_groundtruth.ivecs";
    // const int n = 1000000, n_query = 10000;
    ...
    // Simulating REPETITIONS * n_query search procedure (during dev you can reduce REPETITIONS = 1 for fast testing)
